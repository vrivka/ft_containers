...
public:
	...
	typedef typename std::iterator_traits<Iterator>::iterator_category iterator_category;//	Preserves Iterator's category
	typedef typename std::iterator_traits<Iterator>::value_type value_type;//	Preserves Iterator's value type
	typedef typename std::iterator_traits<Iterator>::difference_type difference_type;//	Preserves Iterator's difference type
	typedef typename std::iterator_traits<Iterator>::pointer pointer;//	Preserves Iterator's pointer type
	typedef typename std::iterator_traits<Iterator>::reference reference;//	Preserves Iterator's reference type
private:
	iterator_type iter;
public:
	...
	reverse_iterator<iterator_type> &operator=(reverse_iterator<iterator_type> const &other) const {
		this->iter = other.iter;
		return *this;
	};
